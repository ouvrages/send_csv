...
Gem::Specification.new do |s|
  ...
  s.authors = ["Ouvrages"]
  s.date = %q{2011-05-05}
  s.default_executable = %q{send_csv}
  s.description = %q{Adds to ApplicationController a send_csv method working like send_file.}
  s.email = ["contact@ouvrages-web.fr"]
  s.executables = ["send_csv"]
  s.extra_rdoc_files = ["History.txt", "Manifest.txt", "README.txt"]
  s.files = [".autotest", "History.txt", "Manifest.txt", "README.txt", "Rakefile", "bin/send_csv", "lib/send_csv.rb", "test/test_send_csv.rb", ".gemtest"]
